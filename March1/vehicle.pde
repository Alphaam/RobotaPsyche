...
class Vehicle {
  ...
  Vehicle(float x, float y, float r, float imsf, float ims, float ie, float metab, float dat, float red, float green, float blue) {
    acceleration = new PVector(0, 0);
    velocity = new PVector(0, 0);
    location = new PVector(x, y);
    dna = new DNA(r, imsf, ims, ie, metab, dat, red, green, blue);
